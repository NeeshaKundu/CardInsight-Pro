@echo off
title Claim Port 3000 for Corporate Card
echo ============================================
echo   CLAIMING PORT 3000 FOR CORPORATE CARD
echo ============================================
echo.

echo 1. Stopping existing services...
net stop CorporateCardFrontend 2>nul && echo ✓ Frontend stopped || echo ℹ️ Frontend not running
net stop CorporateCardBackend 2>nul && echo ✓ Backend stopped || echo ℹ️ Backend not running
...
if %killed% equ 0 echo ℹ️ No processes to kill
